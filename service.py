...
from update_therm import update_therm
...
class AppServerSvc (win32serviceutil.ServiceFramework):
    ...
    def __init__(self,args):
        ...
        self.timeout = 86400000 #Пауза между выполнением основного цикла службы в миллисекундах
    ...
    def SvcPause(self):
        ...
        servicemanager.LogInfoMsg("The %s service.py has paused." % (self._svc_name_, ))

    def SvcContinue(self):
        self.ReportServiceStatus(win32service.SERVICE_CONTINUE_PENDING)
        win32event.SetEvent(self.hWaitResume)
        self.ReportServiceStatus(win32service.SERVICE_RUNNING)
        servicemanager.LogInfoMsg("The %s service.py has resumed." % (self._svc_name_, ))
